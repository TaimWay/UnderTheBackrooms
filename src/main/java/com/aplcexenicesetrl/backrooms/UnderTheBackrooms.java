...
import com.aplcexenicesetrl.backrooms.assets.creative_tab.ModCreativeTab;
...
@Mod(UnderTheBackrooms.MOD_ID)
public class UnderTheBackrooms
{
    public static final String MOD_ID = "backrooms";

    private static final Logger LOGGER = LogUtils.getLogger();

    public UnderTheBackrooms(FMLJavaModLoadingContext context)
    {
